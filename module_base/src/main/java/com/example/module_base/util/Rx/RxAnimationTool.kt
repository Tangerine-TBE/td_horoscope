    ...
    fun startSwitchBackgroundAnim(view: ImageView, bitmap: Bitmap?) {
        ...
        if (oldTransitionDrawable == null) {
            oldTransitionDrawable = TransitionDrawable(arrayOf(oldBitmapDrawable, BitmapDrawable(
                BaseApplication.application.resources, bitmap)))
            ...
            oldTransitionDrawable.setDrawableByLayerId(oldTransitionDrawable.getId(1), BitmapDrawable(BaseApplication.application.resources, bitmap))
        }
